...
parser.add_argument('--labelpath', type=str,
                    default='/home/floraqin/Documents/lisa-cnn-attack/labels/')  ### the ground truth labels of 32*32 original image path
parser.add_argument('--savedir', type=str,
                    default='/home/floraqin/Documents/dvae/training_data/')  ### x,y,adv_x save diretory
...
X_train, Y_train, X_Advtrain = parseTrainingDatawithAdv(imagePath=args.imagepath, labels=args.labelpath,
                                                        AdvPath=args.advpath)
